...
Die Daten stammen aus Simulationen mit fünf verschiedenen Parametern für
die Partikelgröße $h$, Zeitschritt $\Delta t$ und für SSPH die Steifigkeitskonstante $k$.
Ermittelt wurde die benötigte Zeit für 1000 Simulationsschritte. Daraus wurde die durchschnittliche Zeit zwischen zwei Simulationsschritten berechnet.
\begin{center}
    ...
    \end{tabular}
\end{center}
Aus diesen Daten lässt sich schließen, dass die Berechnungszeit für IISPH grob um den Faktor 2.5 länger ist als die Berechnungszeit für SSPH.
...
Daher muss man von einem leicht stärkeren Faktor ausgehen.
