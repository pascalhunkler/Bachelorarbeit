...
Die Daten stammen aus zehn Simulationen, davon jeweils fünf mit SSPH und IISPH.
Es wurden fünf verschiedene Parameter verwendet für
die Partikelgröße $h$, Zeitschritt $\Delta t$ und für SSPH die Steifigkeitskonstante $k$.
Ermittelt wurde die benötigte Zeit für 1000 Simulationsschritte, inklusiv der Zeit, die für die Visualisierung benötigt wird.
Daraus wurde die durchschnittliche Zeit zwischen zwei Simulationsschritten berechnet.
...
\begin{center}
    \begin{tabular}{ l | c c c c }
      & SSPH & IISPH & Verhältnis IISPH zu SSPH\\
      \hline
      $h = 10, \Delta t = 0.02, k = 100000$ & 60 ms & 161 ms & 2.683\\  
      $h = 15, \Delta t = 0.05, k = 50000$ & 36 ms & 88 ms & 2.444\\
      $h = 15, \Delta t = 0.05, k = 100000$ & 35 ms & 94 ms & 2.686\\
      $h = 10, \Delta t = 0.01, k = 1000000$ & 66 ms & 156 ms & 2.363\\
      $h = 20, \Delta t = 0.1, k = 100000$ & 21 ms & 49 ms & 2.333\\
    \end{tabular}
\end{center}
Aus diesen Daten lässt sich schließen, dass die Berechnungszeit für IISPH um den Faktor 2.5 herum länger ist als die Berechnungszeit für SSPH.
Ein Einfluss der Parameter auf diesen Faktor ist nicht zu erkennen.
Es muss jedoch auch berücksichtigt werden, dass in den Daten die Berechnungszeit für die Visualisierung mit eingeflossen ist.
Daher muss von einem leicht größeren Faktor ausgegangen werden.

Um zu ermitteln, wie stark der Einfluss der Berechnungszeit für die Visualisierung ist,
wurde ebenfalls, abhängig von der Partikelgröße $h$, welche auch die Partikelanzahl bestimmt, die durchschnittliche Zeit gemessen,
die für einen Simulationsschritt und für die Visualisierung benötigt wird.
