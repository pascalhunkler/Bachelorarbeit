...
\begin{equation}
    \frac{d\textbf{v}_i}{dt} = -\frac{1}{\rho_i} \nabla p_i + \nu \nabla^2 \textbf{v}_i + \frac{\textbf{F}_i^{other}}{m_i}
\end{equation}
Es muss also in erster Linie die Druckbeschleunigung $-\frac{1}{\rho_i} \nabla p_i$ und
die Viskositätsbeschleunigung $\nu \nabla^2 \textbf{v}_i$ bestimmt werden.
...
\end{equation}
Für die Berechnung der Druckbeschleunigung $-\frac{1}{\rho_i} \nabla p_i$ wird die Diskretisierung des Druckgradienten benötigt.
...
\begin{equation}
    -\frac{1}{\rho_i} \nabla p_f \approx -\frac{1}{\rho_i} \sum_{f_f} A_{f_f} \frac{m_{f_f}}{\rho_{f_f}} \nabla W_{ff_f}
\end{equation}
