...
Die Daten stammen aus acht Simulationen, davon sechs mit IISPH und zwei mit SSPH.
...
\begin{center}
    \begin{tabular}{ r r r | c c }
        ...
        SSPH & $\Delta t = 0.1$ & $k = 10^5$ & 55 ms & 550
    \end{tabular}
\end{center}
...
Um den maximalen Zeitschritt $\Delta t = 0.1$ aus IISPH zu erreichen, muss eine Steifigkeitskonstante von etwa $k = 10^5$ gewählt werden.
Hier kann man jedoch nicht mehr von einer realistischen Simulation sprechen.
