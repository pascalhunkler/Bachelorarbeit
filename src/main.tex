...
In Abbildung \ref{image:particle_size_timestep_iisph} sind die Daten aus den IISPH-Simulationen abgebildet
und in Abbildung \ref{image:particle_size_timestep_ssph} die Daten aus den SSPH-Simulationen.
...
In Abbildung \ref{image:stiffness_timestep_ssph} ist für SSPH der Zusammenhang zwischen der Steifigkeitskonstante und des maximalen Zeitschritts abgebildet.
...
Um einen vergleichbar hohen Zeitschritt wie in IISPH zu erreichen, muss daher eine Steifigkeitskonstante von etwa $k = 10^4$ gewählt werden.
Jedoch führt dies zu recht unrealistischen Simulationen, worauf im nächsten Abschnitt näher eingegangen wird.
