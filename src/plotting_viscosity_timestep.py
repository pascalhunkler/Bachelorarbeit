...
if __name__ == "__main__":
    df_iisph = pd.read_csv("PlotFiles/viscosity_timestep_iisph.txt", sep="\t")
    df_ssph = pd.read_csv("PlotFiles/viscosity_timestep_ssph.txt", sep="\t")
    ...
    plt.xlabel(x_iisph)
    plt.ylabel(y_iisph)
    plt.savefig("Abbildungen/viscosity_timestep.png")